      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mt-5 lg:mx-20 mx-5">
          ...
          <div className="bussiness_ex mt-10 rounded-sm">
            <div className="text-start lg:py-40 lg:pl-20 py-[140px] pl-10">
              <h4 className="text-xl text-white">BUSINESS EXCHANGE MEETING</h4>
              <h2 className="text-3xl pt-2 text-white font-bold">ビジネス交流会</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="py-7 border-t border-gray-200 mt-10 lg:mx-20 mx-2">
          <table className="min-w-full">
            ...
            <tr>
              <th scope="col"
                  className="w-40 h-auto px-6 py-3 bg-gray-100 text-center text-md text-gray-600 font-medium">
                日時
              </th>
        ...
        <div className="py-7 border-t border-gray-200 mt-10 lg:mx-20 mx-2">
          <table className="min-w-full">
            ...
            <tr>
              ...
              <td className="px-6 py-4 lg:border-l-2 lg:border-gray-300">
                <div className="flex items-center h-full">
                  <div className="text-md text-gray-600">閉会</div>
                </div>
              </td>
            </tr>
            </tbody>
