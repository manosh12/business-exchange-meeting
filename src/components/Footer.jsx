        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="py-10 flex justify-between items-center flex-col gap-8 xl:flex-row">
            <div className="flex items-center flex-col xl:flex-row ">
              <Link to="/" className="flex justify-start items-start text-white">
                <h5 className="font-bold text-2xl ml-5 mt-2">BizX Meet</h5>
              </Link>
              <ul
                className="text-lg  flex items-center flex-col md:flex-row  py-8 gap-6 md:gap-12 xl:border-l border-gray-200 xl:ml-11 xl:pl-11 transition-all duration-500">
                <li>
                  <Link to="/" className="text-white font-bold" onClick={TopScroll}>Home</Link>
                </li>
                <li>
                  <Link to="#business_exchange" className="text-white font-bold">ビジネス交流会</Link>
                </li>
                <li>
                  <Link to="#contact" className="text-white font-bold">お問い合わせ</Link>
                </li>
              </ul>
            </div>
            <div className="flex  space-x-4 sm:justify-center">
              ...
              <a href="#"
                 className="group w-9 h-9 rounded-full border text-white flex justify-center items-center transition-all duration-500">
                <svg
                  className="w-[1.25rem] h-[1.125rem] text-white transition-all duration-500"
              ...
              <a href="#"
                 className="group w-9 h-9 rounded-full border border-gray-300 flex justify-center items-center transition-all duration-500 ">
                <svg
                  className="w-[1rem] h-[1rem] text-white transition-all duration-500"
          ...
          <div className="py-7 border-t border-gray-200">
            <div className="flex items-center justify-center">
              <span className="text-gray-400 ">Copyright ©<a
                href="https://pagedone.io/">B.E.Metting</a> 2024, All rights reserved.</span>
            </div>
          </div>
        </div>
